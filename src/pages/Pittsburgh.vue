<template>
  <div>
    ...
    <!-- Booking form -->
    <div id="form">
      <booking-form v-if="formVisible" :companyId="companyId"></booking-form>
    </div>
    <!-- End Booking form -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 webscope">
            <span class="webscope-text"> © Kerb™ 2018. All rights reserved. <br>(412) 904-5063 | Kerb™ Moving #718 2 S 6th St, Pittsburgh, PA 15203. </span>   
          </div>
          <div class="col-sm-4">
